...
//           <span className="text-xs font-bold text-slate-300 uppercase tracking-widest">Backtest Config</span>
//         </div>
//         {isRunning && (
//           <div className="flex items-center gap-2 px-2 py-1 bg-blue-900/20 rounded border border-blue-500/20">
//             <span className="relative flex h-2 w-2">
//               <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
//               <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-500"></span>
//             </span>
//             <span className="text-[10px] font-bold text-blue-300 uppercase">Running</span>
//           </div>
//         )}
//       </div>
...
//           <div className="flex items-center gap-2 pb-2 border-b border-[#2A2E39]">
...
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Backtest Name *</Label>
//               <Input
//                 value={config.name || ''}
//                 onChange={(e) => updateBacktestConfig('name', e.target.value || undefined)}
//                 placeholder="أدخل اسم الباك-تست"
//                 className="h-8 bg-[#0B0E11] border-[#2A2E39] text-xs text-slate-200 focus:border-blue-500 px-2"
//                 required
//               />
//             </div>
...
//                 required
//               >
//                 <SelectTrigger className="h-8 bg-[#0B0E11] border-[#2A2E39] text-xs text-slate-200 focus:border-blue-500">
...
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Market *</Label>
//               <Select
//                 value={config.market || ''}
...
//               rows={2}
//               className="bg-[#0B0E11] border-[#2A2E39] text-xs text-slate-200 focus:border-blue-500 px-2 resize-none"
//             />
//           </div>
...
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Symbols *</Label>
//               <Badge variant="outline" className="text-[9px] border-[#2A2E39] text-slate-500 bg-[#0B0E11] h-4 px-1">
//                 {symbols.length}
//               </Badge>
//             </div>
//             <div className="flex gap-2">
//               <Select value={newSymbol} onValueChange={setNewSymbol}>
//                 <SelectTrigger className="h-8 bg-[#0B0E11] border-[#2A2E39] text-xs text-slate-200 flex-1">
...
//                 </SelectContent>
//               </Select>
//               <Button onClick={() => addSymbol(newSymbol)} disabled={!newSymbol} size="icon" className="h-8 w-8 bg-[#2A2E39] hover:bg-[#363C45] text-slate-300">
//                 <Plus className="h-3 w-3" />
//               </Button>
//             </div>
//             <div className="flex flex-wrap gap-1.5 p-2 bg-[#0B0E11] border border-[#2A2E39] rounded-sm">
//               {symbols.map(symbol => (
//                 <Badge key={symbol} variant="secondary" className="bg-[#1E222D] border-[#2A2E39] text-slate-300 text-[10px] h-6 px-2 pr-1 hover:border-red-500/50 hover:text-red-400 transition-colors flex items-center gap-1.5">
//                   <span className="font-mono">{symbol}</span>
//                   <button onClick={() => removeSymbol(symbol)} className="p-0.5 hover:bg-red-900/20 rounded">
...
//         {/* 2. CAPITAL & SIZING */}
//         <div className="space-y-4 pt-4 border-t border-[#2A2E39]">
//           <div className="flex items-center gap-2 pb-2">
//             <Coins className="h-3.5 w-3.5 text-slate-500" />
//             <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Capital & Sizing *</h3>
//           </div>

//           <div className="grid grid-cols-2 gap-3">
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Initial Capital *</Label>
//               <Input
//                 type="number"
//                 step={100}
//                 min={100}
...
//                 className="h-8 bg-[#0B0E11] border-[#2A2E39] text-xs text-slate-200 font-mono focus:border-blue-500 px-2"
//                 required
//               />
//             </div>
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Sizing Method *</Label>
//               <Select
...
//                 <Label className="text-[9px] font-bold text-slate-500 uppercase">Position Size % *</Label>
//                 <span className="text-[10px] font-mono text-blue-400">{config.position_size_percent || 0}%</span>
//               </div>
//               <Slider
...
//             </div>
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Max Positions *</Label>
//               <Input
//                 type="number"
//                 min={1}
//                 max={20}
...
//             <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Execution *</h3>
//           </div>

//           <div className="grid grid-cols-2 gap-3">
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Commission % *</Label>
...
//                   className="h-8 bg-[#0B0E11] border-[#2A2E39] text-xs text-slate-200 font-mono focus:border-blue-500 px-2 pr-6"
//                   required
//                 />
//                 <span className="absolute right-2 top-2 text-[10px] text-slate-600 pointer-events-none">%</span>
//               </div>
//             </div>
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Slippage % *</Label>
//               <div className="relative">
//                 <Input
//                   type="number"
//                   step={0.001}
...
//             <div className="flex items-center gap-2 p-2 bg-[#1E222D] border border-[#2A2E39] rounded-sm">
//               <Checkbox
//                 id="short"
//                 checked={config.enable_short_selling || false}
//                 onCheckedChange={(c) => updateBacktestConfig('enable_short_selling', !!c)}
//                 className="border-[#363C45]"
//               />
//               <Label htmlFor="short" className="text-[10px] text-slate-300 cursor-pointer">Short</Label>
//             </div>
//             <div className="flex items-center gap-2 p-2 bg-[#1E222D] border border-[#2A2E39] rounded-sm">
//               <Checkbox
//                 id="margin"
...
//                 className="border-[#363C45]"
//               />
//               <Label htmlFor="margin" className="text-[10px] text-slate-300 cursor-pointer">Margin</Label>
//             </div>
//             <div className="flex items-center gap-2 p-2 bg-[#1E222D] border border-[#2A2E39] rounded-sm">
//               <Checkbox
//                 id="conf"
...
//                 className="border-[#363C45]"
//               />
//               <Label htmlFor="conf" className="text-[10px] text-slate-300 cursor-pointer">Confirm</Label>
//             </div>
//           </div>
//         </div>
...
//             <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Strategy Risk *</h3>
//           </div>
...
//             </div>
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Max Position Size % *</Label>
//               <div className="flex items-center gap-2">
//                 <Slider
...
//                   className="flex-1"
//                 />
//                 <span className="text-[10px] font-mono w-8 text-right text-slate-300">
...
//             </div>
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Max Concurrent *</Label>
//               <Input
//                 type="number"
//                 min={1}
...
//             </div>
//             <div className="space-y-1.5">
//               <Label className="text-[9px] font-bold text-slate-500 uppercase">Position Side *</Label>
//               <Select
...
//       {/* --- FOOTER --- */}
//       <div className="p-4 border-t border-[#2A2E39] bg-[#1E222D] shrink-0">
...
//           <div className="flex items-center gap-2 p-2 rounded bg-red-900/10 border border-red-900/20">
//             <AlertTriangle className="h-4 w-4 text-red-400" />
//             <span className="text-[10px] text-red-300">Missing required fields (*)</span>
//           </div>
//         ) : (
//           <Button
//             onClick={onRunBacktest}
//             disabled={isRunning}
//             className="w-full h-9 bg-[#2962FF] hover:bg-[#1E53E4] text-white font-bold text-xs shadow-lg shadow-blue-900/20 border border-blue-500/50 uppercase tracking-wider"
//           >
//             {isRunning ? (
